...
//new method inserting node at the end of the list
...
//new method to check the number of nodes
int List::size() {
	Node * ptr = first_;
	int count = 0;
...
//new method to check the sum of the double entry in nodes
double List::sum() {
	Node * ptr = first_;
	double sum = 0;
	...
	cout << "Sum of double entries in nodes: " << sum << "\n" << endl;
	return sum;
}
